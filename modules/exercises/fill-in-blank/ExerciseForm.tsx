...
const difficultyOptions = {
  ...
  medium: {
    ...
    level: "B1-B2",
    description:
      "Moderately complex sentences with common phrases. Suitable for B1-B2 level learners.",
  },
  hard: {
    title: "Hard",
    level: "C1-C2",
    description:
      "Complex sentences with advanced vocabulary. Suitable for C1-C2 level learners.",
  },
};
...
export default function ExerciseForm({
  ...
  const [numberOfSentences, setNumberOfSentences] = useState<5 | 10 | 20>(20);
